...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <!-- //Navigation -->
            <?php
                //count total ads under fashion category
                $query = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE (category LIKE 'Clothes' OR category LIKE 'Footwear' OR category LIKE 'Others')";
                $run_query = mysql_query($query);
                $total_ad = mysql_result($run_query,0);
                $query1 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Clothes'";
                $run_query1 = mysql_query($query1);
                $clothes_ad = mysql_result($run_query1,0);  
                $query2 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Footwear'";
                $run_query2 = mysql_query($query2);
                $footwear_ad = mysql_result($run_query2,0);
                $query3 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Others'";
            ...
            <div>
                ...
                <img src="images/fash.jpg" height="200px" >  
            </div>
            <div class="categoriesbody">
                <h1 class="af-bf"><span>Browse<br/>Sub-Categories</span></h1>
                <div class="col-6">
                    <a href="#">Clothes (<strong><?php echo $clothes_ad.' Ads' ?> </strong>)</a>
                    
                </div>
                <div class="col-6">
                    <a href="#">Footwear (<strong><?php echo $footwear_ad.' Ads' ?> </strong>)</a>
                </div>
                <div class="col-6">
                    <a href="#">Others (<strong><?php echo $other_ad.' Ads' ?> </strong>)</a>
                </div>
            </div><br><br><br><br><br><br><br><br>
            <div>
                <h1 class="af-bf"><span>See all Ads </span></h1>
                <?php
                $query = "SELECT * FROM ad_information WHERE (category LIKE 'Clothes' OR category LIKE 'Footwear' OR category LIKE 'Others') ORDER BY ad_id DESC";
