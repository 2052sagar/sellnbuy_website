    ...
    <body>
        ...
        <div id="main">
            ...
            <?php
                ...
                $query = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE (category LIKE 'Education & Classes' OR category LIKE 'Electronics & Computer Repair' OR category LIKE 'Maids & Domestics Help' OR category LIKE 'Health & Beauty' OR category LIKE 'Drivers & Taxi' OR category LIKE 'Other Services')";
                $run_query = mysql_query($query);
                $total_ad = mysql_result($run_query,0);
                $query1 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Education & Classes'";
                $run_query1 = mysql_query($query1);
                $education_ad = mysql_result($run_query1,0);  
                $query2 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Electronics & Computer Repair'";
                $run_query2 = mysql_query($query2);
                $electronic_ad = mysql_result($run_query2,0);
                $query3 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Maids & Domestics Help'";
                $run_query3 = mysql_query($query3);
                $maid_ad = mysql_result($run_query3,0); 
                $query4 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Health & Beauty'";
                $run_query4 = mysql_query($query4);
                $health_ad = mysql_result($run_query4,0);
                $query5 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Drivers & Taxi'";
                $run_query5 = mysql_query($query5);
                $driver_ad = mysql_result($run_query5,0);
                $query6 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Other Services'";
                $run_query6 = mysql_query($query6);
                $other_ad = mysql_result($run_query6,0);
            ?>
            <div>
                <h1 class="categoriesheading">Services</h1> 
                <h4 style="text-align:center;">(<?php echo $total_ad.' Ads' ?>)</h4>
                <img src="images/serve.jpg" height="200px" >  
            </div>
            <div class="categoriesbody">
                <h1 class="af-bf"><span>Browse<br/>Sub-Categories</span></h1>
                <div class="col-6">
                    <a href="#">Education & Classes (<strong><?php echo $education_ad.' Ads' ?> </strong>)</a>  
                </div>
                <div class="col-6">
                    <a href="#">Electronics & Computer Repair (<strong><?php echo $electronic_ad.' Ads' ?> </strong>)</a>
                </div>
                <div class="col-6">
                    <a href="#">Maids & Domestics Help (<strong><?php echo $maid_ad.' Ads' ?> </strong>)</a>
                </div>
                <div class="col-6">
                    <a href="#">Health & Beauty (<strong><?php echo $health_ad.' Ads' ?> </strong>)</a>   
                </div>
                <div class="col-6">
                    <a href="#">Drivers & Taxi (<strong><?php echo $driver_ad.' Ads' ?> </strong>)</a>
                </div>
                <div class="col-6">
                    <a href="#">Other Services (<strong><?php echo $other_ad.' Ads' ?> </strong>)</a>
                </div>
            </div><br><br><br><br><br><br><br><br>
            <div>
                <h1 class="af-bf"><span>See all Ads </span></h1>
                <?php
                $query = "SELECT * FROM ad_information WHERE (category LIKE 'Education & Classes' OR category LIKE 'Electronics & Computer Repair' OR category LIKE 'Maids & Domestics Help' OR category LIKE 'Health & Beauty' OR category LIKE 'Drivers & Taxi' OR category LIKE 'Other Services') ORDER BY ad_id DESC";
