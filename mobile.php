...
<html>
    ...
    <body>
        ...
        <div id="main">
            ...
            <!-- //Navigation -->
            <?php
                //count total ads under mobile category 
                $query1 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE (category LIKE 'Mobile Phones' OR category LIKE 'Tablets')";
                $run_query1 = mysql_query($query1);
                $total_ad = mysql_result($run_query1,0);  
                $query2 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Mobile Phones'";
                $run_query2 = mysql_query($query2);
                $mobile_ad = mysql_result($run_query2,0);
                $query3 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Tablets'";
                $run_query3 = mysql_query($query3);
                $tablet_ad = mysql_result($run_query3,0); 
            ?>
            <div>
                <h1 class="categoriesheading">Mobiles</h1> 
                <h4 style="text-align:center;">(<?php echo $total_ad.' Ads' ?>)</h4>
                <img src="images/mob.jpg" height="200px" >  
            </div>
            <div class="categoriesbody">
                <h1 class="af-bf"><span>Browse<br/>Sub-Categories</span></h1>
                <div class="col-6">
                    <a href="#">Mobile Phones (<strong><?php echo $mobile_ad.' Ads' ?> </strong>) </a> 
                </div>
                <div class="col-6">
                    <a href="#">Tablets (<strong><?php echo $tablet_ad.' Ads' ?> </strong>) </a>
                </div>
            </div><br><br><br><br><br><br><br><br>
            <div>
                <h1 class="af-bf"><span>See all Ads </span></h1>
                <?php
                $query = "SELECT * FROM ad_information WHERE (category LIKE 'Mobile Phones' OR category LIKE 'Tablets') ORDER BY ad_id DESC";
