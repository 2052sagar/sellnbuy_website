    ...
    <body>
        ...
        <div id="main">
            ...
            <?php
                ...
                $query = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE (category LIKE 'Computers & Accessories' OR category LIKE 'Tv - Video - Audio' OR category LIKE 'Cameras & Accessories' OR category LIKE 'Games & Entertainment' OR category LIKE 'Fridge - AC - Washing Machine' OR category LIKE 'Kitchen & Other Appliances')";
                $run_query = mysql_query($query);
                $total_ad = mysql_result($run_query,0);
                $query1 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Computers & Accessories'";
                $run_query1 = mysql_query($query1);
                $compacc_ad = mysql_result($run_query1,0);  
                $query2 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Tv - Video - Audio'";
                $run_query2 = mysql_query($query2);
                $tv_ad = mysql_result($run_query2,0);
                $query3 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Cameras & Accessories'";
                $run_query3 = mysql_query($query3);
                $camacc_ad = mysql_result($run_query3,0); 
                $query4 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Games & Entertainment'";
                $run_query4 = mysql_query($query4);
                $game_ad = mysql_result($run_query4,0);
                $query5 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Fridge - AC - Washing Machine'";
                $run_query5 = mysql_query($query5);
                $fridge_ad = mysql_result($run_query5,0);
                $query6 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Kitchen & Other Appliances'";
                $run_query6 = mysql_query($query6);
                $kitchen_ad = mysql_result($run_query6,0);
            ?>
            <div>
                <h1 class="categoriesheading">Electronics & Appliances</h1> 
                <h4 style="text-align:center;">(<?php echo $total_ad.' Ads' ?>)</h4>
                <img src="images/electronicsAppliances.jpg" height="200px" >  
            </div>
            <div class="categoriesbody"> 
                <h1 class="af-bf"><span>Browse<br/>Sub-Categories</span></h1>
                <div class="col-6">
                    <a href="#">Computers & Accessories (<strong><?php echo $compacc_ad.' Ads' ?> </strong>)</a>  
                </div>
                <div class="col-6">
                    <a href="#">Tv - Video - Audio (<strong><?php echo $tv_ad.' Ads' ?> </strong>)</a>
                </div>
                <div class="col-6">
                    <a href="#">Cameras & Accessories (<strong><?php echo $camacc_ad.' Ads' ?> </strong>)</a>
                </div>
                <div class="col-6">
                    <a href="#">Games & Entertainment (<strong><?php echo $game_ad.' Ads' ?> </strong>)</a> 
                </div>
                <div class="col-6">
                    <a href="#">Fridge - AC - Washing Machine (<strong><?php echo $fridge_ad.' Ads' ?> </strong>)</a>
                </div>
                <div class="col-6">
                    <a href="#">Kitchen & Other Appliances (<strong><?php echo $kitchen_ad.' Ads' ?> </strong>)</a>
                </div>
            </div><br><br><br><br><br><br><br><br>
            <div>
                <h1 class="af-bf"><span>See all Ads </span></h1>
                <?php
                $query = "SELECT * FROM ad_information WHERE (category LIKE 'Computers & Accessories' OR category LIKE 'Tv - Video - Audio' OR category LIKE 'Cameras & Accessories' OR category LIKE 'Games & Entertainment' OR category LIKE 'Fridge - AC - Washing Machine' OR category LIKE 'Kitchen & Other Appliances') ORDER BY ad_id DESC";
