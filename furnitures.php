    ...
    <body>
        ...
        <div id="main">
            ...
            <?php
                ...
                $query = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE (category LIKE 'Sofa & Dining' OR category LIKE 'Beds & Wardrobes' OR category LIKE 'Home Decor & Garden' OR category LIKE 'Other Household Items')";
                $run_query = mysql_query($query);
                $total_ad = mysql_result($run_query,0);
                $query1 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Sofa & Dining'";
                $run_query1 = mysql_query($query1);
                $sofa_ad = mysql_result($run_query1,0);  
                $query2 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Beds & Wardrobes'";
                $run_query2 = mysql_query($query2);
                $bed_ad = mysql_result($run_query2,0);
                $query3 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Home Decor & Garden'";
                $run_query3 = mysql_query($query3);
                $homedecor_ad = mysql_result($run_query3,0); 
                $query4 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Other Household Items'";
                $run_query4 = mysql_query($query4);
                $other_ad = mysql_result($run_query4,0);
            ?>
            <div>
                <h1 class="categoriesheading">Furnitures</h1> 
                <h4 style="text-align:center;">(<?php echo $total_ad.' Ads' ?>)</h4>
                <img src="images/furni.jpg" height="200px" >  
            </div>
            <div class="categoriesbody">
                <h1 class="af-bf"><span>Browse<br/>Sub-Categories</span></h1>
                <div class="col-6">
                    <a href="#">Sofa & Dining (<strong><?php echo $sofa_ad.' Ads' ?> </strong>)</a>
                    
                </div>
                <div class="col-6">
                    <a href="#">Beds & Wardrobes (<strong><?php echo $bed_ad.' Ads' ?> </strong>)</a>
                </div>
                <div class="col-6">
                    <a href="#">Home Decor & Garden (<strong><?php echo $homedecor_ad.' Ads' ?> </strong>)</a>
                </div>
                <div class="col-6">
                    <a href="#">Other Household Items (<strong><?php echo $other_ad.' Ads' ?> </strong>)</a>
                </div>
            </div><br><br><br><br><br><br><br><br>
            <div>
                <h1 class="af-bf"><span>See all Ads </span></h1>
                <?php
                $query = "SELECT * FROM ad_information WHERE (category LIKE 'Sofa & Dining' OR category LIKE 'Beds & Wardrobes' OR category LIKE 'Home Decor & Garden' OR category LIKE 'Other Household Items') ORDER BY ad_id DESC";
