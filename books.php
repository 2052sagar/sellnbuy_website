...
<html>
    <head>
        <title>books, sports & hobbies</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div id="main">
            ...
            <?php
                ...
                $query = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE (category LIKE 'Books & Magazines' OR category LIKE 'Sports Equipment' OR category LIKE 'Musical Instruments' OR category LIKE 'Gym & Fitness' OR category LIKE 'Other Hobbies')";
                $run_query = mysql_query($query);
                $total_ad = mysql_result($run_query,0);
                $query1 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Books & Magazines'";
                $run_query1 = mysql_query($query1);
                $book_ad = mysql_result($run_query1,0);  
                $query2 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Sports Equipment'";
                $run_query2 = mysql_query($query2);
                $sport_ad = mysql_result($run_query2,0);
                $query3 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Musical Instruments'";
                $run_query3 = mysql_query($query3);
                $music_ad = mysql_result($run_query3,0); 
                $query4 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Gym & Fitness'";
                $run_query4 = mysql_query($query4);
                $gym_ad = mysql_result($run_query4,0);
                $query5 = "SELECT COUNT(*) AS count_ad FROM ad_information WHERE category LIKE 'Other Hobbies'";
                $run_query5 = mysql_query($query5);
                $other_ad = mysql_result($run_query5,0);
            ?>
            <div>
                <h1 class="categoriesheading">Books, Sports & Hobbies</h1>
                <h4 style="text-align:center;">(<?php echo $total_ad.' Ads' ?>)</h4> 
                <img src="images/bookssports.jpg" height="200px" >  
            </div>
            <div class="categoriesbody">
                <h1 class="af-bf"><span>Browse<br/>Sub-Categories</span></h1>      
                <div class="col-6">
                    <a href="#">Books & Magazines (<strong><?php echo $book_ad.' Ads' ?> </strong>)</a>  
                </div>
                <div class="col-6">
                    <a href="#">Sports Equipment (<strong><?php echo $sport_ad.' Ads' ?> </strong>)</a>
                </div>
                <div class="col-6">
                    <a href="#">Musical Instruments (<strong><?php echo $music_ad.' Ads' ?> </strong>)</a>
                </div>
                <div class="col-6">
                    <a href="#">Gym & Fitness (<strong><?php echo $gym_ad.' Ads' ?> </strong>)</a>                   
                </div>
                <div class="col-6">
                    <a href="#">Other Hobbies (<strong><?php echo $other_ad.' Ads' ?> </strong>)</a>
                </div>
            </div><br><br><br><br><br><br><br><br>
            <div>
                <h1 class="af-bf"><span>See all Ads </span></h1>
                <?php
                $query = "SELECT * FROM ad_information WHERE (category LIKE 'Books & Magazines' OR category LIKE 'Sports Equipment' OR category LIKE 'Musical Instruments' OR category LIKE 'Gym & Fitness' OR category LIKE 'Other Hobbies') ORDER BY ad_id DESC";
